...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost\\SQLEXPRESS01;Database=cursach;Trusted_Connection=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Available>(entity =>
        {
            entity.HasKey(e => e.AvailableId).HasName("PK__Availabl__BCFE5BA0093D7889");
        ...
        {
            entity.HasKey(e => e.ClientId).HasName("PK__Client__E67E1A046C661C8E");
        ...
        {
            entity.HasKey(e => e.ItemId).HasName("PK__Item__727E83EBEFB09991");
        ...
        {
            entity.HasKey(e => e.ItemTypeId).HasName("PK__ItemType__F51540DB80C96D94");
        ...
        {
            entity.HasKey(e => e.ReservedId).HasName("PK__Reserved__4E080CE68C8025D6");
        ...
        {
            entity.HasKey(e => e.SoldId).HasName("PK__Sold__3F0E668948072956");
