...
namespace cursach.Controllers
{
    public class ReservedsController : Controller
    {
        ...
        public ReservedsController(CursachItemsContext context)
        {
            _context = context;
        }
        ...
        {
            var cursachItemsContext = _context.Reserveds.Include(r => r.Client);
        ...
        public async Task<IActionResult> Details(DateOnly reservedDate)
        {
            ...
            if (reserved == null)
            {
                return NotFound($"No item found with Item Name: {reserved}");
            }
        ...
        public async Task<IActionResult> Create([Bind("ReservedId,ClientId,ReservedDate,ExpirationDate,InterestRate")] Reserved reserved)
        {
            ...
            ViewData["Client"] = new SelectList(_context.Clients, "ClientId", "LastName", reserved.ClientId);
            return View(reserved);
        }
