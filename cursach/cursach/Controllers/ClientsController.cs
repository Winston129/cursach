...
namespace cursach.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public ClientsController(CursachContext context)
        {
            _context = context;
        }
        ...
        // GET: Clients/Details?firstName=John
        public async Task<IActionResult> Details(string firstName)
        {
            if (string.IsNullOrWhiteSpace(firstName))
            {
                return NotFound("FirstName is required.");
            }
            ...
            if (client == null)
            {
                return NotFound($"No client found with FirstName: {firstName}");
            }
