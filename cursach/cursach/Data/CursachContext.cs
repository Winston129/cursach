...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AvailableId).HasName("PK__Availabl__BCFE5BA029C31B06");
        ...
        {
            entity.HasKey(e => e.ClientId).HasName("PK__Client__E67E1A04D418B18D");
        ...
        {
            entity.HasKey(e => e.ItemId).HasName("PK__Item__727E83EBA4573F20");
        ...
        {
            entity.HasKey(e => e.ItemTypeId).HasName("PK__ItemType__F51540DB4027BF37");
        ...
        {
            entity.HasKey(e => e.ReservedId).HasName("PK__Reserved__4E080CE6A46D86A3");
        ...
        {
            entity.HasKey(e => e.SoldId).HasName("PK__Sold__3F0E66895AE58FD6");
